...
1. **[Check System Requirements](/system-requirements)** — Ensure your server meets all prerequisites
2. **[Choose Installation Method](/installation/)** — Select VPS, Docker, cPanel, or Hostinger
3. **[Add Payment Gateways](/gateways)** — Connect your payment methods
4. **[Start Accepting Payments](/payment-links)** — Create your first payment link or invoice
...
**Need Help?**  
Contact support through your client area at [my.uddoktapay.com](https://my.uddoktapay.com) or consult the documentation for detailed guides on every feature.

**Ready to Install?**  
Head to [System Requirements](/system-requirements) to verify your server compatibility, then proceed to the [Installation Guide](/installation/).